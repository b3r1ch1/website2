					...
					<div class="selection list-group-flush">
						<?php
							...
							foreach($productlist as $row) {
								echo '< span class="list-group-item list-group-item-action">'.$row['thumbnail'].'</span>';
							}
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt Sieu cay</h5>
                        <p>8,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt Chi thien</h5>
                        <p>5,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt tam gia</h5>
                        <p>6,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3 pt-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt long giang</h5>
                        <p>7,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3 pt-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt An Giang</h5>
                        <p>2,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3 pt-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt Nam Dinh</h5>
                        <p>1,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3 pt-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt Gia Lai</h5>
                        <p>3,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3 pt-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt Ninh Binh</h5>
                        <p>4,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
            ...
            <div class="col-sm-3 pt-3">
                <div class="card">
                    <img class="card-img-top" src="images/otngot.jpg" alt="Card image cap">
                    <div class="card-body">
						<h5 class="card-title" name="iphone">Ớt Tia</h5>
                        <p>2,000,000₫</p>
                        <a href="#" class="btn btn-secondary">Thêm vào giỏ</a>
                    </div>
                </div>
